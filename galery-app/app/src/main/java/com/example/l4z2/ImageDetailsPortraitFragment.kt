...
class ImageDetailsPortraitFragment : Fragment() {

    var rating :Float = 0.0f
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
                              savedInstanceState: Bundle?): View? {
        // Inflate the layout for this fragment
        return inflater.inflate(R.layout.fragment_image_details_portrait, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val buttonSave = view!!.findViewById<Button>(R.id.buttonSaveP)
    ...
    fun setViewDisplay(img:Int, description:String, rating:Float){
        val imgView = view!!.findViewById<ImageView>(R.id.imageViewFullSize_P)
        val descView = view!!.findViewById<TextView>(R.id.textViewDescription_P)
        val ratingView = view!!.findViewById<RatingBar>(R.id.ratingBar_P)
